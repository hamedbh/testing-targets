...
Something else we can test is whether the models perform better after some feature selection, using the [Boruta package](https://cran.r-project.org/package=Boruta). 
